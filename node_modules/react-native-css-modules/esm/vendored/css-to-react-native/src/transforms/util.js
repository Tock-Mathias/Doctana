import { LENGTH, UNSUPPORTED_LENGTH_UNIT, PERCENT, COLOR, SPACE, NONE, } from '../tokenTypes';
export const directionFactory = ({ types = [LENGTH, UNSUPPORTED_LENGTH_UNIT, PERCENT], directions = ['Top', 'Right', 'Bottom', 'Left'], prefix = '', suffix = '', }) => tokenStream => {
    const values = [];
